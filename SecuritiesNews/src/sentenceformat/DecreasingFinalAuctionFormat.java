...
public class DecreasingFinalAuctionFormat extends SecuritiesSentenceFormat {
	...
	public DecreasingFinalAuctionFormat() {
		super(TOPIC_NAME);
	...
	public DecreasingFinalAuctionFormat(List <DailySecuritiesNews> newsList) {
		super(TOPIC_NAME);
	...
	private String formatStyle1(String name, String date, String changePrice, String closingPrice) {
		return "Khép lại khớp lệnh phiên chiều ngày " + date + ", " + name + " giảm " + changePrice + " điểm, lùi về mức " + closingPrice + " điểm. ";
	}
	
	private String formatStyle2(String name, String date, String changePrice, String finalTradingStock, String finalTradingPrice) {
		return "Ngày " + date + name + " giảm " + changePrice + " mua bán thận trọng khi chỉ có " + finalTradingStock + " cổ phiếu khớp lệnh, trị giá "+ finalTradingPrice + " đồng. ";
	}
	
	private String formatStyle3(String name, String closingPrice, String finalTradingStock, String finalTradingPrice) {
		return "Kết thúc khớp lệnh cuối cùng, " + name + " chỉ còn " + closingPrice + " điểm, với " + finalTradingStock + " cổ phiếu khớp lệnh, trị giá " + finalTradingPrice + " đồng. ";
	}
